...
{
	public class ExplosiveJellyBlob : ModItem
	{
		public override void SetStaticDefaults()
		{
			base.SetStaticDefaults();
			DisplayName.SetDefault("Explosive Jelly Blob");
		}
		...
		public override void SetDefaults()
		{
			...
			item.autoReuse = true;
			item.shoot = mod.ProjectileType("ExplodingEletricDiamond");
			item.shootSpeed = 8f;       
		}
		...
		public override void AddRecipes() //25 sunplate blocks, 10 rain clouds, 60 clouds, and 10 platinum bars
		{
            ...
            recipe.AddIngredient(mod.ItemType("Jelly"), 6);  
            recipe.AddIngredient(ItemID.Bomb, 4);  
            recipe.AddIngredient(mod.ItemType("JellyBlob"));  
